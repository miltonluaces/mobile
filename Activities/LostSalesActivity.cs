...
namespace GUI  {
	...
	[Activity (Label = "Venta Perdida", Icon = "@drawable/logoSm")]			
	public class LostSalesActivity : Activity	{

		#region Events

		protected override void OnCreate(Bundle bundle)  {
			base.OnCreate(bundle);
			SetContentView (Resource.Layout.LostSales);
			List<float> lostSalesTS = Dataset.Instance.GetDataSubset ("TimeSeries", "Total").data[4];
			SetChart(lostSalesTS.ToArray(), Color.Pink, Color.White, Color.Black);
		}
